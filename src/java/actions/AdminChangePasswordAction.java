 ...
 * @author arpan
 */
public class AdminChangePasswordAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if(username!=null&&username.compareTo("")!=0)
        {
            try
            {
                ...
                {
                    qp.connect();
                    query = "update administrator_acc set password=\"" + newPassword + "\" where username=\"" + username + "\" and password=\"" + currPassword + "\";";
