<%-- 
    Document   : headerweb
    Created on : Mar 19, 2011, 1:01:58 PM
    Author     : Arpan
--%>
...
<html>
    ...
    <body>
        ...
        <div id="header">
            ...
            %>
            <div align="right">
                <font size="2"><b>Welcome <a href="editProfile.do" style="color:white" title="Edit your profile"><%=userID%></a></b> &nbsp;&nbsp;</font>
            </div>
            <%
                }
            %>
            <h1 id="logo"><a href="index.jsp" style="color:white;">Intranet Web Search</a></h1>
